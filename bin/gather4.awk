...
# of header of normalized peak activities and normalized peak activities in bt, hc and gg (by alphabetical order) and makes a single
# matrix with human hits with 1 and only 1 hit from bt, hc and gg 
...
# pgm=/work/project/fragencode/tools/multi/Scripts/Awk/gather4.awk
# time cat ../../4species.besthit.merged.max1eachspecies.tsv | awk -v fileRef1=$header1 -v fileRef2=$peak1 -v fileRef3=$header2 -v fileRef4=$peak2 -v fileRef5=$header3 -v fileRef6=$peak3 -f $pgm > 3species.bthcgg.orth.peaks.access.each.sample.tsv
...
# chr1	1574444	1574688	bos_taurus:16:52191332-52192318:798.697:24.4422:80.4979:intergenic,capra_hircus:16:49552453-49553534:286.484:22.2942:80.9129:tss,gallus_gallus:21:2112843-2113798:203.61:17.5916:75:tss,sus_scrofa:6:63754391-63755728:657.248:18.2498:79.918:tss,	4
$5>=3&&$4~/bos_taurus/&&$4~/capra_hircus/&&$4~/gallus_gallus/{
    split($4,a,",");
    k=1;
    while(a[k]!="")
    {
    ...
    print $1":"$2"-"$3, (val[coord["bos_taurus"]])(val[coord["capra_hircus"]])(val[coord["gallus_gallus"]]);
}
